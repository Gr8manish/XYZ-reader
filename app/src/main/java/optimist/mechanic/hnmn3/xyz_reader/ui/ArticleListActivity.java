package optimist.mechanic.hnmn3.xyz_reader.ui;
...
import optimist.mechanic.hnmn3.xyz_reader.R;
import optimist.mechanic.hnmn3.xyz_reader.data.ArticleLoader;
import optimist.mechanic.hnmn3.xyz_reader.data.ItemsContract;
import optimist.mechanic.hnmn3.xyz_reader.data.UpdaterService;
...
public class ArticleListActivity extends ActionBarActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCollapsingToolbarLayout.setCollapsedTitleTextColor(
                ContextCompat.getColor(ArticleListActivity.this, android.R.color.white));
